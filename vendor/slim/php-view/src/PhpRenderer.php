...
class PhpRenderer
{
    ...
    public function render(ResponseInterface $response, $template, array $data = [])
    {
        ...
        //renderrizando o conteudo dos modulos junto com o layout
        $this->renderLayout($response, array("render_content"=>$output));
     ...
     * @throws \RuntimeException
     */
    public function renderLayout(ResponseInterface $response, array $data = [])
    {
        $output = $this->fetch("/layout.php", $data);
